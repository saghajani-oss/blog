...
<!-- ======================================================== END OF HEADER SECTION ======================================================== -->
    ...
    <section class="featured">
      <div class="container featured__container">
        <div class="post__thumbnail">
          <img src="images/blog1.jpg" alt="street-art">
        </div>
        <div class="post__info">
          <a href="category-post.php" class="category__button">Art</a>
          <h2 class="post__title">
            <a href="post.php">What is Street Art?</a>
          </h2>
          <p class="post__body">
            Street art is visual art created in public locations for public
            visibility. It has been associated with the terms "independent art,"
            "post-graffiti", "neo-graffiti" and guerrilla art. Street art has
            evolved from the early forms of defiant graffiti into a more
            commercial form of art, as one of the main differences now lies with
            the messaging. Street art is often meant to provoke thought rather
            than rejection among the general audience through making its purpose
            more evident than that of graffiti. The issue of permission has also
            come at the heart of street art, as graffiti is usually done
            illegally, whereas street art can nowadays be the product of an
            agreement or even sometimes a commission. However, it remains
            different from traditional art exposed in public spaces by its
            explicit use of said space in the conception phase.
          </p>
          <div class="post__author">
            <div class="post__author-avatar">
              <img src="images/avatar2.jpg" alt="author-pic">
            </div>
            <div class="post__author-info">
              <h5>By: Omid Lotfi</h5>
              <small>August 23, 2023 - 07:23</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container posts__container">
        <article class="post">
          ...
          <div class="post__info">
            ...
            <h3 class="post__title">
              <a href="post.php">Can robots replace humans?</a>
            </h3>
            <p class="post__body">
        ...
        <article class="post">
          ...
          <div class="post__info">
            ...
            <h3 class="post__title">
              <a href="post.php">What is a chameleon?</a>
            </h3>
            <p class="post__body">
        ...
        <article class="post">
          ...
          <div class="post__info">
            <a href="category-posts.php" class="category__button">Society</a>
            <h3 class="post__title">
              <a href="post.php">Why do festivals bring joy to humans?</a>
            </h3>
            <p class="post__body">
        ...
        <article class="post">
          ...
          <div class="post__info">
            ...
            <h3 class="post__title">
              <a href="post.php">Art for Self-Care and Mental Health</a>
            </h3>
            <p class="post__body">
        ...
        <article class="post">
          ...
          <div class="post__info">
            ...
            <h3 class="post__title">
              <a href="post.php">Planning a Recreational Boating Travel</a>
            </h3>
            <p class="post__body">
        ...
        <article class="post">
          ...
          <div class="post__info">
            <a href="category-posts.php" class="category__button">Entertainment</a>
            <h3 class="post__title">
              <a href="post.php">About Rubik’s Cube </a>
            </h3>
            <p class="post__body">
    ...
    <section class="category__buttons">
      <div class="container category__buttons-container">
        <a href="category-posts.php" class="category__button">Art</a>
        <a href="category-posts.php" class="category__button">Technology</a>
        <a href="category-posts.php" class="category__button">Wilde Life</a>
        <a href="category-posts.php" class="category__button">Society</a>
        <a href="category-posts.php" class="category__button">Travel</a>
        <a href="category-posts.php" class="category__button">Entertainment </a>
      </div>
